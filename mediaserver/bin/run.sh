...
JAVA_OPTS="-Dprogram.name=$PROGNAME $JAVA_OPTS -Djavax.net.ssl.trustStore=/opt/Restcomm-JBoss-AS7-7.6.0.825/standalone/configuration/keystore.jks -Djavax.net.ssl.trustStorePassword=Mt020215as2009"
